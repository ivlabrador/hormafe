...
sr.reveal(`#about-1, .menu-items, .side-1, .delivery-l`, {origin: 'left'}) // about-imageContent -- hacer transición manualmente 
sr.reveal(`.about-details, .menu-items-r, .delivery-r, .info-logo `, {origin: 'right'})
sr.reveal(`.menu-items-c`, {origin: 'bottom'})